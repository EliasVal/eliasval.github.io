...
<main id="header">
	<img
		in:fade={{ delay: 150, easing: cubicOut, duration: 800 }}
		src="/svgs/logo-white.svg"
		alt=""
	/>
	<div class="content">
		<h1 class="primary-title" in:fly={{ y: 100, delay: 700, duration: 1000, easing: cubicOut }}>
			Hi, I'm
			<GradientText rgbValues={['#EA6302', '#EB7413', '#F09712']} direction={'to right'}>
				Elias Valkonsky
			</GradientText>
		</h1>
		<h2 class="secondary-title" in:fly={{ y: 100, delay: 800, duration: 1000, easing: cubicOut }}>
			Welcome to my
			<GradientText rgbValues={['#FFFF0F', '#FFFF42']} direction={'to right'}>
				Portfolio
			</GradientText>
		</h2>
		<div class="socials" in:fade={{ delay: 2000, duration: 1750, easing: cubicOut }}>
